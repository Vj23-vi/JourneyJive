...
//   // const searchPlaces = () => {
//   //         if(destination.target.value==Sydney || destination.target.value==sydney ){
//   //           <NavLink to= "/places"/>
//   //         }
//   // };

//   const searchPlaces = (destination) => {
//   // Ensure destination exists before accessing its properties
//   if (destination && (destination.target.value.toLowerCase() === 'sydney')) {
//     return <NavLink to="/places" />;
//   }
// };
...
//             <button className="bg-gradient-to-r from-primary to-secondary text-white hover:scale-105 px-4 py-2 rounded-full duration-200 absolute -bottom-5 left-1/2 -translate-x-1/2" onClick={()=>searchPlaces}>
//               Search Now
//             </button>
//                   {/* </NavLink> */}
//           </div>
